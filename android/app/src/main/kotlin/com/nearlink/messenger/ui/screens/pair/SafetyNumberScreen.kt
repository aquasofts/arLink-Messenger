...
fun SafetyNumberScreen(
    viewModel: SafetyConfirmViewModel,
    onBack: () -> Unit,
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text(state.title.ifBlank { stringResource(R.string.pair_safety_title) }) },
                navigationIcon = {
        ...
        Column(
            ...
            Row(horizontalArrangement = Arrangement.spacedBy(16.dp)) {
                ...
                Button(
                    ...
                    onClick = { viewModel.confirm { convId -> onConfirmed(convId) } },
